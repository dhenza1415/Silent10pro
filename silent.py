...
ki1 = LINETCR.LINE()
ki1.login(token="EpcZ0hDxMZvDnxf2iGs5.7xCRRg3YdpRmzn8omFJ9rq.0ztWhbBKZMZSSMWb0VLCZL/t+yV9F7lSPNtUOZc0AgY=")
ki1.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["ufdc20b3a00b5e8f31e4f91017eb361b0",mid,ki1,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10]
self = ["ufdc20b3a00b5e8f31e4f91017eb361b0",mid,ki1,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10]
admin = "ufdc20b3a00b5e8f31e4f91017eb361b0"
admsa = "ufdc20b3a00b5e8f31e4f91017eb361b0"
owner = "ufdc20b3a00b5e8f31e4f91017eb361b0"
adminMID = "ufdc20b3a00b5e8f31e4f91017eb361b0"
...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me Cteator ",
    "lang":"JP",
    "comment":"AutoLike By : [Ŧз₳M SILENT ฿❂Ŧ]",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        ki2.sendText(op.param1,"Wekawekaweka (kapok)")
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","-_-","dhenza lagi off", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","SILENT -_-"]
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'ufdc20b3a00b5e8f31e4f91017eb361b0'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/dhenz415")
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"Ŧз₳M SILENT ฿❂Ŧ")
                        ki2.sendText(msg.to,"Ŧз₳M SILENT ฿❂Ŧ")
                        ki3.sendText(msg.to,"[Ŧз₳M SILENT ฿❂Ŧ]")
                        ...
                        G.preventJoinByTicket(G)
                        ki1.updateGroup(G)
            elif msg.text in ["ออก","บอทออก","Bye","#bye","Pulang"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                ...
                cl.sendText(msg.to,"""[[Ŧз₳M SILENT ฿❂Ŧ]]\n\n
[Ŧз₳M SILENT ฿❂Ŧ] List siri
คำสั่งบอท siri
...
#==================================================
                ...
                cl.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[{[Ŧз₳M SILENT ฿❂Ŧ]}] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
...
""")
                ...
                for j in xrange(k+1):
                    ...
                    ki1.sendMessage(msg) 
            elif msg.text in ["Bot?","เทส","SILENT"]:
...
#เทส
            ...
            elif "Silent killer " in msg.text:
                                bctxt = msg.text.replace("Silent killer ","")
...
#========================================
            elif "Silen3 @" in msg.text:            
                print "[Command]dp executing"
                _name = msg.text.replace("Silent3 @","")
                _nametarget = _name.rstrip('  ')
                gs = cl.getGroup(msg.to)
                targets = []
                for g in gs.members:
            ...
            elif "Silent2mid:" in msg.text:
                umid = msg.text.replace("Silent2mid:","")
                ...
                try:
                    ...
                    cl.sendText(msg.to,(error))
                    pass
            elif "Silent2 " in msg.text:
                if msg.toType == 2:
                    msg.contentType = 0
                    steal0 = msg.text.replace("Silent2 ","")
...
#===============================================
                ...
                ki.sendText(msg.to, "[Ŧз₳M SILENT ฿❂Ŧ]\n\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off\n\n[By.~dhenz415]")
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        pass
#-------------------------------------------------
            elif msg.text in ["เปิดหมด","Silent all on"]:
                        cl.sendText(msg.to,"─┅══ईह[Ŧз₳M SILENT ฿❂Ŧ]ईह══┅─\n\n[SELF BOT PHET HACK BOT]")
                        cl.sendText(msg.to,"Please wait......")
            ...
            elif msg.text in ["ปิดหมด","Silent all off"]:
                        cl.sendText(msg.to,"─┅══ईह[Ŧз₳M SILENT ฿❂Ŧ]ईह══┅─\n\n[Ŧз₳M ฿❂Ŧ PROTECT]")
                        cl.sendText(msg.to,"Please wait......")
...
#========================================
                ...
                if msg.toType == 2:
                    ...
                    ki1.sendText(msg.to, "Hello all... sorry ya gosongin😁😁 {}")
                    targets = []
                    for g in gs.members:
